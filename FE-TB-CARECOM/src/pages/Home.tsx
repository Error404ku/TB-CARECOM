    ...
    <ModernLayout>
      ...
      <div className="py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Laporkan kondisi kesehatan harian Anda dengan mudah menggunakan QR Code
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            <QRScanner 
              title="Scan QR Code Daily Monitoring"
              description="Gunakan QR Code dari tenaga kesehatan untuk mengisi laporan harian"
            />
          </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-200/50">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-4">Laporan Harian Mudah</h3>
            <div className="space-y-3 text-gray-600">
              <div className="flex items-start space-x-3">
                <span className="text-green-600 font-bold">1.</span>
                <span>Scan QR Code yang diberikan tenaga kesehatan</span>
              </div>
              <div className="flex items-start space-x-3">
                <span className="text-green-600 font-bold">2.</span>
                <span>Isi waktu minum obat dan kondisi kesehatan</span>
              </div>
              <div className="flex items-start space-x-3">
